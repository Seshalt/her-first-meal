...
const SUPPORT = [
  ...
  { icon: ListChecks, title: "Stage guidance", body: "Pregnancy and postpartum guidance is organized by your saved stage and week — no chatbot required." },
  ...
  { icon: MessageCircle, title: "No generative AI", body: "Your questions and profile are not sent to a generative AI model. Personalization comes from the content library and your choices." },
];
        ...
        <section>
          <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 pb-16 pt-12 md:grid-cols-2 md:pt-16">
            <div>
              ...
              <h1 className="mt-3 font-display text-5xl">Smart personalization without the AI bill.</h1>
              <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
                Her First Meal uses a deep built-in recipe and wellness library, your dietary choices, your pregnancy or postpartum stage, and the stores you prefer. When you want a human, Maat is still here.
              </p>
